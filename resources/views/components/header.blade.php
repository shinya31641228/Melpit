                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                        ...
                        <div class="dropdown-item-text">
                            <div class="row no-gutters">
                                ...
                                <div class="col-auto">{{number_format($user->soldProducts->count())}} 個</div>
                            </div>
                        </div>
                        ...
                        <a class="dropdown-item" href="{{ route('mypage.listing-list') }}">
                            <i class="fas fa-store-alt text-left" style="width: 30px"></i>出品した商品
                        </a>
                        <a class="dropdown-item" href="{{ route('mypage.purchase-list') }}">
